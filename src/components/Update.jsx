...
//     const updatedOngoingPatients = ongoingPatients.filter(patient => patient.id !== id);
//     const completedPatient = ongoingPatients.find(patient => patient.id === id);
//     completedPatient.status = 'completed';

//     setOngoingPatients(updatedOngoingPatients);
//     setCompletedPatients([...completedPatients, completedPatient]);
//     try {
//       await axios.post(`http://localhost:8090/patient`, completedPatient);
//       window.alert("Patient status updated successfully");
//     } catch (error) {
...
//       fetchData(); // Fetch updated patient list after deletion
//     } catch (error) {
...
//     // const updatedOngoingPatients = [];
//     const completedPatient = ongoingPatients.find(patient => patient.id === id);
//     completedPatient.status = 'completed';
//   window.alert(completedPatient._id)
//     // setOngoingPatients(updatedOngoingPatients);
...
//                 <span>Gender: {patient.gender}</span>
//                 <span>Problem: {patient.problem}</span>
//                 <span >Number: {patient.number}</span> {/* Add className here */}
//                 <button onClick={() => handleComplete(patient.id)}>Complete</button>
//               </li>
//             ))}
//           </ul>
